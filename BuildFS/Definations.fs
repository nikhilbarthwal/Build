...
type typeDef = {Type:basicTypeDef; Params:basicTypeDef list}
...
type program = {LowerDefinitions:Map<lowerKey, lowerDefination>; UpperDefinitions:Map<upperKey, upperDefination>}
...
type fileGenerator = {Name:expr; Location:expr; Block:block<block<predStatement>>}

type errorGenerator = {Message:expr; Block:block<block<predStatement>>}
