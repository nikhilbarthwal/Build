...
define('project', term('p', [type('token', 'ProjectName'), list('p_pair', 'ProjectArgs')])).
...
parse('p_pair', 'p_pair', [optmatch('white'), readtokens('pvar_name', 'N'), match('symbols','='), readtokens('pvar_value', 'V')], 'var(N, V)').

parse('pvar_name', 'token', [optmatch('white'), readtokens('identifier1', 'X')], 'X').

%parse('pvar_value', 'token', [optmatch('white'), readtokens('identifier1', 'X')], 'X').
parse('pvar_value', 'token', [optmatch('white'), readtokens('identifier0', 'X')], 'X').
...
parse('statement', 'p_statement', error2('Unable to understand the statement'), dummy).
